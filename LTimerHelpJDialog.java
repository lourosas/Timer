...
This file is part of the LTimer
LTimter is free software; you can redistribute it
and/or modify
...
public class LTimerHelpJDialog extends JDialog{
   ...
   ////////////////////Public Methods/////////////////////////////////
   /**/
   public static LTimerHelpJDialog instance(JFrame frame, String txt){
      if(_instance == null){
   ...
   /**/
   public static LTimerHelpJDialog instance(){
      if(_instance == null){
         _instance = new LTimerHelpJDialog(null, "");
      }
      return _instance;
   }
   ...
   ////////////////////////Private Contructors////////////////////////
   /**/
   private LTimerHelpJDialog(JFrame frame, String text){
